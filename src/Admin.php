...
use Closure;
use Lambq\Admin\Auth\Database\Menu;
use Lambq\Admin\Layout\Content;
use Lambq\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \Lambq\Admin\Layout\Content
     */
     ...
     * Get navbar object.
     *
     * @return \Lambq\Admin\Widgets\Navbar
     */
    ...
    public function registerAuthRoutes()
    {
        $attributes = [
            ...
            'namespace'  => 'Lambq\Admin\Controllers',
