...
use Lambq\Admin\Grid\Column;
use Lambq\Admin\Grid\Displayers\Actions;
use Lambq\Admin\Grid\Displayers\RowSelector;
use Lambq\Admin\Grid\Exporter;
use Lambq\Admin\Grid\Filter;
use Lambq\Admin\Grid\Model;
use Lambq\Admin\Grid\Row;
use Lambq\Admin\Grid\Tools;
...
class Grid
{
    ...
    {
        $map = [
            'editable'    => \Lambq\Admin\Grid\Displayers\Editable::class,
            'switch'      => \Lambq\Admin\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \Lambq\Admin\Grid\Displayers\SwitchGroup::class,
            'select'      => \Lambq\Admin\Grid\Displayers\Select::class,
            'image'       => \Lambq\Admin\Grid\Displayers\Image::class,
            'label'       => \Lambq\Admin\Grid\Displayers\Label::class,
            'button'      => \Lambq\Admin\Grid\Displayers\Button::class,
            'link'        => \Lambq\Admin\Grid\Displayers\Link::class,
            'badge'       => \Lambq\Admin\Grid\Displayers\Badge::class,
            'progressBar' => \Lambq\Admin\Grid\Displayers\ProgressBar::class,
            'radio'       => \Lambq\Admin\Grid\Displayers\Radio::class,
            'checkbox'    => \Lambq\Admin\Grid\Displayers\Checkbox::class,
            'orderable'   => \Lambq\Admin\Grid\Displayers\Orderable::class,
        ];
