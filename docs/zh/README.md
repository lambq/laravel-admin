...
[![Packagist](https://img.shields.io/packagist/l/lambqlaravel-admin.svg?maxAge=2592000)](https://packagist.org/packages/lambqlaravel-admin)
[![Total Downloads](https://img.shields.io/packagist/dt/lambqlaravel-admin.svg?style=flat-square)](https://packagist.org/packages/lambqlaravel-admin)
...
```
Laravel 5.2
composer require lambqlaravel-admin "dev-master"

Laravel 5.3
composer require lambqlaravel-admin "1.3.x-dev"

Laravel 5.1
composer require lambqlaravel-admin "1.1.x-dev"
```

在`config/app.php`加入`ServiceProvider`:

```
Lambq\Admin\AdminServiceProvider::class
```
