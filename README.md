...
<p align="center">
    ...
    <a href="https://packagist.org/packages/lambqlaravel-admin">
        <img src="https://img.shields.io/packagist/l/lambqlaravel-admin.svg?maxAge=2592000&&style=flat-square" alt="Packagist">
    </a>
    <a href="https://packagist.org/packages/lambqlaravel-admin">
        <img src="https://img.shields.io/packagist/dt/lambqlaravel-admin.svg?style=flat-square" alt="Total Downloads">
    </a>
...
```
composer require lambq/laravel-admin
```

Then run these commands to publish assets and config：

```
php artisan vendor:publish --provider="Lambq\Admin\AdminServiceProvider"
```
